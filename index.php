...
<body>
                ...
                <div class="contact-form" data-aos="fade-left" data-aos-delay="400">
                    <form id="contactForm" onsubmit="return handleSignIn(event)" method="post" action="register.php" >
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="subject" class="form-input"  name="subject" required>
                        </div>
                        <div class="form-group">
                            <label for="message" class="form-label">Message</label>
                            <textarea id="message" class="form-input form-textarea"  name="message" required></textarea>
                        </div>
                        <input type="submit" class="btn form-submit" id="submitBtn" name="submit" value="Send Message" required>
    ...
    <!-- INSERT INTO `contact_form` (`id`, `name`, `email`, `subject`, `message`) VALUES ('1', 'Text Name', 'Example@gmail.com', 'create a e-commerce website', 'my name is nabbia'); -->
</body>
</html>
